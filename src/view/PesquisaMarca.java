 ...
 * @author u11289134103
 */
public class PesquisaMarca extends javax.swing.JDialog {

    /**
     * Creates new form Pesquisar
     */
    public PesquisaMarca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PesquisaMarca dialog = new PesquisaMarca(new javax.swing.JFrame(), true);
