 ...
 * @author u11289134103
 */
public class PesquisaEmpresa extends javax.swing.JDialog {

    /**
     * Creates new form Pesquisar
     */
    public PesquisaEmpresa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PesquisaEmpresa dialog = new PesquisaEmpresa(new javax.swing.JFrame(), true);
