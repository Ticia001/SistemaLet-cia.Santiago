 ...
 * @author u11289134103
 */
public class PesquisaEndereco extends javax.swing.JDialog {

    /**
     * Creates new form Pesquisar
     */
    public PesquisaEndereco(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Pesquisar Endereco");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PesquisaEndereco dialog = new PesquisaEndereco(new javax.swing.JFrame(), true);
