 ...
 * @author u11289134103
 */
public class PesquisaVendedor extends javax.swing.JDialog {

    /**
     * Creates new form Pesquisar
     */
    public PesquisaVendedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisaVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PesquisaVendedor dialog = new PesquisaVendedor(new javax.swing.JFrame(), true);
